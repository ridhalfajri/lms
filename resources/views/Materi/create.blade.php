...
@endpush
@section('content')
    <form action="{{ route('materi.store') }}" method="POST" id="frm-materi" enctype="multipart/form-data">
        @csrf
            ...
            <div class="box-content card white">
                ...
                <div class="card-content">
                    ...
                    <div class="form-group @error('deskripsi') has-error @enderror">
                        ...
                        <textarea class="form-control" placeholder="Tuliskan deskripsi" name="deskripsi" id="deskripsi">{{ old('deskripsi') }}</textarea>
                        @error('deskripsi')
                            <div class="invalid-feedback text-danger">
                                {{ $message }}
                            </div>
                    ...
                    <div class="checkbox margin-bottom-20">
                        <input type="checkbox" name="is_show" value="1" id="is_show"><label for="is_show">Tampilkan
                            materi</label>
                    </div>
